...
# )
# env = gym.make('FrozenLakeNotSlippery-v1', render_mode = "ansi")
...
env = gym.make('FrozenLake-v1')#Initialize table with all zeros to be uniform
Q = np.zeros([env.observation_space.n, env.action_space.n])# Learning parameters

alpha = 0.1
gamma = 0.95
num_episodes = 2000# array of reward for each 
